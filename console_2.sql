...
VALUES ('Nguyen Van A', 'ana@gmail.com'),
    ('Tran Thi B', 'btithi@yahoo.com'),
    ('Le Van C', 'clevan@outlook.com'),
    ('Pham Minh D', 'dminh@company.com');

INSERT INTO orders (customer_id, amount, order_date)
VALUES (1, 1500, '2026-03-01'),
    (1, 2000, '2026-03-15'),
    (2, 5000, '2026-03-10'),
    (3, 1200, '2026-03-20'),
    (2, 300,  '2026-03-25');
...
BEGIN
    ...
    IF NOT v_customer_exists THEN
        RAISE EXCEPTION 'Loi: Khach hang voi ID % khong ton tai trong he thong!', p_customer_id;
    END IF;

    -- 3. Nếu tồn tại, thực hiện thêm đơn hàng mới
    INSERT INTO orders (customer_id, amount, order_date)
    VALUES (p_customer_id, p_amount, CURRENT_DATE); -- Dùng CURRENT_DATE để lấy ngày hiện tại

    RAISE NOTICE 'Them don hang thanh cong cho khach hang ID %', p_customer_id;
END;
$$;
